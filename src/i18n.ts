...
type Strings = {
  ...
  s_showFps: string;
  s_smoothScale: string;
  s_hwAccel: string;
  s_compressHtml: string;
  s_defaultBg: string;
  s_defaultZoom: string;
  s_showGrid: string;
  s_cursorCross: string;
  s_saveLastPath: string;
...
const T: Record<Lang, Strings> = {
  ru: {
    ...
    s_animSpeed: 'Скорость анимации (мс)',
    s_autoPlay: 'Автовоспроизведение видео',
    s_maxFrames: 'Макс. кадров для видео',
    s_defaultWidth: 'Ширина по умолчанию',
    s_defaultPalette: 'Палитра по умолчанию',
    s_defaultFontRatio: 'Пропорции шрифта по умолчанию',
    s_showFps: 'Показывать FPS в плеере',
    s_smoothScale: 'Сглаживание при масштабировании',
    s_hwAccel: 'Аппаратное ускорение',
    s_compressHtml: 'Сжимать HTML вывод (RLE)',
    s_defaultBg: 'Цвет фона по умолчанию',
    s_defaultZoom: 'Масштаб по умолчанию',
    s_showGrid: 'Показывать сетку вьюпорта',
    s_cursorCross: 'Курсор-прицел во вьюпорте',
    s_saveLastPath: 'Запоминать последний путь',
    s_notifications: 'Уведомления',
    s_logLevel: 'Уровень логирования',
    s_maxHistory: 'Макс. история файлов',
  ...
  en: {
    ...
    s_animSpeed: 'Animation speed (ms)',
    s_autoPlay: 'Auto-play video',
    s_maxFrames: 'Max video frames',
    s_defaultWidth: 'Default width',
    s_defaultPalette: 'Default palette',
    s_defaultFontRatio: 'Default font ratio',
    s_showFps: 'Show FPS in player',
    s_smoothScale: 'Smooth scaling',
    s_hwAccel: 'Hardware acceleration',
    s_compressHtml: 'Compress HTML output (RLE)',
    s_defaultBg: 'Default background color',
    s_defaultZoom: 'Default zoom',
    s_showGrid: 'Show viewport grid',
    s_cursorCross: 'Crosshair cursor in viewport',
    s_saveLastPath: 'Remember last path',
    s_notifications: 'Notifications',
    s_logLevel: 'Log level',
    s_maxHistory: 'Max file history',
  ...
  de: { appTitle:'ASCII Art Studio', openImage:'Bild', openVideo:'Video / GIF',
    ...
    splashReady:'Bereit!',
    s_showStars:'Sterne anzeigen', s_animSpeed:'Animationsgeschw. (ms)',
    s_autoPlay:'Autoplay', s_maxFrames:'Max. Frames',
    s_defaultWidth:'Standardbreite', s_defaultPalette:'Standard-Palette',
    s_defaultFontRatio:'Standard-Schriftverhältnis', s_showFps:'FPS anzeigen',
    s_smoothScale:'Glatte Skalierung', s_hwAccel:'Hardwarebeschl.',
    s_compressHtml:'HTML komprimieren', s_defaultBg:'Standard-Hintergrund',
    s_defaultZoom:'Standard-Zoom', s_showGrid:'Raster anzeigen',
    s_cursorCross:'Fadenkreuz', s_saveLastPath:'Pfad merken',
    s_notifications:'Benachrichtigungen', s_logLevel:'Protokollebene',
    s_maxHistory:'Max. Verlauf', uploadFont:'Schrift hochladen',
  ...
  fr: { appTitle:'ASCII Art Studio', openImage:'Image', openVideo:'Vidéo / GIF',
    ...
    splashReady:'Prêt!',
    s_showStars:'Afficher étoiles', s_animSpeed:'Vitesse animation (ms)',
    s_autoPlay:'Lecture auto', s_maxFrames:'Max images',
    s_defaultWidth:'Largeur défaut', s_defaultPalette:'Palette défaut',
    s_defaultFontRatio:'Rapport police défaut', s_showFps:'Afficher FPS',
    s_smoothScale:'Mise à l\'échelle lisse', s_hwAccel:'Accél. matérielle',
    s_compressHtml:'Compresser HTML', s_defaultBg:'Fond défaut',
    s_defaultZoom:'Zoom défaut', s_showGrid:'Afficher grille',
    s_cursorCross:'Curseur croix', s_saveLastPath:'Mémoriser chemin',
    s_notifications:'Notifications', s_logLevel:'Niveau journal',
    s_maxHistory:'Historique max', uploadFont:'Charger police',
  ...
  zh: { appTitle:'ASCII艺术工作室', openImage:'图像', openVideo:'视频/GIF',
    ...
    splashReady:'就绪！',
    s_showStars:'显示星星', s_animSpeed:'动画速度(ms)', s_autoPlay:'自动播放',
    s_maxFrames:'最大帧数', s_defaultWidth:'默认宽度', s_defaultPalette:'默认调色板',
    s_defaultFontRatio:'默认字体比例', s_showFps:'显示FPS',
    s_smoothScale:'平滑缩放', s_hwAccel:'硬件加速',
    s_compressHtml:'压缩HTML', s_defaultBg:'默认背景色',
    s_defaultZoom:'默认缩放', s_showGrid:'显示网格',
    s_cursorCross:'十字光标', s_saveLastPath:'记住路径',
    s_notifications:'通知', s_logLevel:'日志级别',
    s_maxHistory:'最大历史', uploadFont:'上传字体',
  ...
  ja: { appTitle:'ASCIIアートスタジオ', openImage:'画像', openVideo:'動画/GIF',
    ...
    splashReady:'準備完了！',
    s_showStars:'星を表示', s_animSpeed:'アニメ速度(ms)', s_autoPlay:'自動再生',
    s_maxFrames:'最大フレーム', s_defaultWidth:'デフォルト幅',
    s_defaultPalette:'デフォルトパレット', s_defaultFontRatio:'デフォルトフォント比率',
    s_showFps:'FPSを表示', s_smoothScale:'スムーズスケール',
    s_hwAccel:'ハードウェアアクセラレーション', s_compressHtml:'HTML圧縮',
    s_defaultBg:'デフォルト背景色', s_defaultZoom:'デフォルトズーム',
    s_showGrid:'グリッド表示', s_cursorCross:'十字カーソル',
    s_saveLastPath:'パスを記憶', s_notifications:'通知',
    s_logLevel:'ログレベル', s_maxHistory:'最大履歴',
  ...
  es: { appTitle:'ASCII Art Studio', openImage:'Imagen', openVideo:'Video / GIF',
    ...
    splashReady:'¡Listo!',
    s_showStars:'Mostrar estrellas', s_animSpeed:'Velocidad animación (ms)',
    s_autoPlay:'Reproducción automática', s_maxFrames:'Máx. fotogramas',
    s_defaultWidth:'Ancho predeterminado', s_defaultPalette:'Paleta predeterminada',
    s_defaultFontRatio:'Relación fuente predeterminada', s_showFps:'Mostrar FPS',
    s_smoothScale:'Escala suave', s_hwAccel:'Aceleración hardware',
    s_compressHtml:'Comprimir HTML', s_defaultBg:'Fondo predeterminado',
    s_defaultZoom:'Zoom predeterminado', s_showGrid:'Mostrar cuadrícula',
    s_cursorCross:'Cursor en cruz', s_saveLastPath:'Recordar ruta',
    s_notifications:'Notificaciones', s_logLevel:'Nivel registro',
    s_maxHistory:'Historial máximo', uploadFont:'Subir fuente',
  ...
  pt: { appTitle:'ASCII Art Studio', openImage:'Imagem', openVideo:'Vídeo / GIF',
    ...
    splashReady:'Pronto!',
    s_showStars:'Mostrar estrelas', s_animSpeed:'Velocidade animação (ms)',
    s_autoPlay:'Reprodução automática', s_maxFrames:'Máx. quadros',
    s_defaultWidth:'Largura padrão', s_defaultPalette:'Paleta padrão',
    s_defaultFontRatio:'Proporção fonte padrão', s_showFps:'Mostrar FPS',
    s_smoothScale:'Escala suave', s_hwAccel:'Aceleração hardware',
    s_compressHtml:'Comprimir HTML', s_defaultBg:'Fundo padrão',
    s_defaultZoom:'Zoom padrão', s_showGrid:'Mostrar grade',
    s_cursorCross:'Cursor em cruz', s_saveLastPath:'Lembrar caminho',
    s_notifications:'Notificações', s_logLevel:'Nível de log',
    s_maxHistory:'Histórico máximo', uploadFont:'Carregar fonte',
    customTheme:'Tema personalizado', themeEditor:'Editor de tema',
    themeNames: THEME_NAMES_EN,
  ...
  ko: { appTitle:'ASCII 아트 스튜디오', openImage:'이미지', openVideo:'비디오/GIF',
    ...
    splashReady:'준비 완료!',
    s_showStars:'별 표시', s_animSpeed:'애니메이션 속도 (ms)',
    s_autoPlay:'자동 재생', s_maxFrames:'최대 프레임',
    s_defaultWidth:'기본 너비', s_defaultPalette:'기본 팔레트',
    s_defaultFontRatio:'기본 글꼴 비율', s_showFps:'FPS 표시',
    s_smoothScale:'부드러운 스케일링', s_hwAccel:'하드웨어 가속',
    s_compressHtml:'HTML 압축', s_defaultBg:'기본 배경색',
    s_defaultZoom:'기본 확대/축소', s_showGrid:'그리드 표시',
    s_cursorCross:'십자 커서', s_saveLastPath:'경로 기억',
    s_notifications:'알림', s_logLevel:'로그 수준',
    s_maxHistory:'최대 히스토리', uploadFont:'글꼴 업로드',
  ...
  it: { appTitle:'ASCII Art Studio', openImage:'Immagine', openVideo:'Video / GIF',
    ...
    splashReady:'Pronto!',
    s_showStars:'Mostra stelle', s_animSpeed:'Velocità animazione (ms)',
    s_autoPlay:'Riproduzione automatica', s_maxFrames:'Max fotogrammi',
    s_defaultWidth:'Larghezza predefinita', s_defaultPalette:'Palette predefinita',
    s_defaultFontRatio:'Rapporto carattere predefinito', s_showFps:'Mostra FPS',
    s_smoothScale:'Scala uniforme', s_hwAccel:'Accelerazione hardware',
    s_compressHtml:'Comprimi HTML', s_defaultBg:'Sfondo predefinito',
    s_defaultZoom:'Zoom predefinito', s_showGrid:'Mostra griglia',
    s_cursorCross:'Cursore a croce', s_saveLastPath:'Ricorda percorso',
    s_notifications:'Notifiche', s_logLevel:'Livello log',
    s_maxHistory:'Cronologia max', uploadFont:'Carica font',
